...
order by Type_Name,trace_column_id         
        ...
        public string GetFormattedData(int idx, string format)
        {
            switch (ProfilerEventColumns.ProfilerColumnDataTypes[idx])
            {
                ...
                case ProfilerColumnDataType.DateTime:
                    System.DateTime d = GetDateTime(idx);
        ...
        private System.DateTime GetDateTime(int idx)
        {
            return ColumnIsSet(idx) ? (System.DateTime)m_Events[idx] : new System.DateTime(0);
        }

        private System.Guid GetGuid(int idx)
        {
            return ColumnIsSet(idx) ? (System.Guid)m_Events[idx] : System.Guid.Empty;
        }
...
order by trace_column_id
        ...
        public System.DateTime StartTime { get { return GetDateTime(ProfilerEventColumns.StartTime); } }
        public System.DateTime EndTime { get { return GetDateTime(ProfilerEventColumns.EndTime); } }
        ...
        public System.Guid GUID { get { return GetGuid(ProfilerEventColumns.GUID); } }
    ...
    public class RawTraceReader
    {
        ...
        private readonly System.Data.SqlClient.SqlConnection m_Conn;
        ...
        public RawTraceReader(System.Data.SqlClient.SqlConnection con)
        {
            m_Conn = con;
        ...
        private void SetDateTimeColumn(ProfilerEvent evt, int columnid)
        {
            ...
            evt.m_Events[columnid] = new System.DateTime(year, month, day, hour, min, sec, msec);
        ...
        {
            evt.m_Events[columnid] = System.Text.Encoding
                .Unicode.GetString((byte[])m_Reader[2]);
        ...
        public void SetEvent(int eventId, params int[] columns)
        {
            ...
            System.Data.SqlClient.SqlParameter p = 
                cmd.Parameters.Add("@columnid", System.Data.SqlDbType.Int);
            
            cmd.Parameters.Add("@on", System.Data.SqlDbType.Bit).Value = 1;
                ...
                switch (columnId)
                {
                    ...
                    default:
                        throw new System.Exception(
                            string.Format("Unsupported column_id: {0}", columnId)
                        );
                }
            }
            cmd.ExecuteNonQuery();
        ...
        public void SetFilter(int columnId, int logicalOperator, int comparisonOperator, string value)
        {
            ...
            {
                cmd.Parameters.Add("@value", System.Data.SqlDbType.NVarChar, value.Length)
                    .Value = value;
            }
            cmd.ExecuteNonQuery();
        }
        ...
        public void CreateTrace()
        {
            ...
            cmd.Parameters.Add("@traceid", System.Data.SqlDbType.Int).Direction = 
                System.Data.ParameterDirection.Output;
            
            cmd.Parameters.Add("@options", System.Data.SqlDbType.Int).Value = 1;
            
            cmd.Parameters.Add("@trace_file", System.Data.SqlDbType.NVarChar, 245).Value = 
                System.DBNull.Value;
            
            cmd.Parameters.Add("@maxfilesize", System.Data.SqlDbType.BigInt).Value = 
                System.DBNull.Value;
            
            cmd.Parameters.Add("@stoptime", System.Data.SqlDbType.DateTime).Value = 
                System.DBNull.Value;
            
            cmd.Parameters.Add("@filecount", System.Data.SqlDbType.Int).Value = 
                System.DBNull.Value;
            
            cmd.Parameters.Add("@result", System.Data.SqlDbType.Int).Direction = 
        ...
        private void ControlTrace(System.Data.SqlClient.SqlConnection con, int status)
        {
            System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand
            {
                  Connection = con
        ...
        public void CloseTrace(System.Data.SqlClient.SqlConnection con)
        {
            ControlTrace(con, 2);
        }

        public void StopTrace(System.Data.SqlClient.SqlConnection con)
        {
            ControlTrace(con, 0);
        }
        ...
        private void GetReader()
        {
            ...
            cmd.Parameters.Add("@traceid", System.Data.SqlDbType.Int).Value = m_TraceId;
            cmd.Parameters.Add("@records", System.Data.SqlDbType.Int).Value = 0;
            
            m_Reader = cmd.ExecuteReader(System.Data.CommandBehavior.SingleResult);
        }
